...
const Milestones = ({ blok }) => (
  <div {...storyblokEditable(blok)}>
    <section className="Milestones bg-purple-200 rounded md:mx-24 lg:mx-32 m-8 mt-0 p-4">
      <h1 className="font-bungee font-bold text-3xl text-center md:text-left" {...storyblokEditable(blok)}>
        {blok.label}
      </h1>
              ...
              <div className="p-2" key={milestone._uid}>
                <div className="Card-1 bg-white rounded-md p-2 w-full justify-center md:inline-flex">
                  ...
                  <img
                    ...
                    {...storyblokEditable(milestone)}
                  ></img>
                  </div>
                  <div className="md:ml-2 md:flex-col">
                    <p className={`font-play font-bold text-${milestone.label_size}xl text-center justify-center`} {...storyblokEditable(milestone)}>
                      {milestone.label}
                    </p>
                    <p className="font-press-start font-bold text-3xl md:text-5xl text-center justify-center" {...storyblokEditable(milestone)}>
