    ...
    return (
        <div className="fixed inset-0 z-20 overflow-y-auto">
            ...
            <div className="flex items-center min-h-screen px-4 py-8">
                    ...
                    <div
                        className="relative mx-auto mb-12 flex w-full max-w-[762px] flex-col items-center justify-between gap-6 rounded-[10px] bg-white px-9 pt-9 pb-14 shadow-box sm:flex-row"
                    >
                        <div 
