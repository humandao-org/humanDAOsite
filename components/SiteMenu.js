  ...
  return (
    <nav className="sticky z-20 top-0 px-6 py-6 bg-[#F8F3F3]">
      <div className="mx-auto flex w-full max-w-[1100px] items-center justify-between gap-5">
        ...
        <ul className="md:hidden flex flex-col gap-4 md:flex-row md:items-center md:gap-12">{children}</ul>
          ...
          <ul className="flex flex-col gap-4 md:flex-row md:items-center md:gap-12">
            ...
            <li>
              <Link href={`/${community ? community : ''}#faqs`}>
                <a className="text-black hover:underline text-[15px] font-medium">FAQ</a>
              </Link>
            </li>
            <li>
