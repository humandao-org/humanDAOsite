...
const Section = ({ blok }) => (
  <div>
    <section className="Section bg-purple-200 rounded md:mx-24 lg:mx-32 m-8 mt-0 p-4" {...storyblokEditable(blok)}>
      ...
      <div className={`grid grid-cols-${blok.cols ? blok.cols : '1'} md:grid-cols-${blok.cols_md ? blok.cols_md : '1'} lg:grid-cols-${blok.cols_lg ? blok.cols_lg : '1'} gap-2 md:gap-5 lg:gap-2 py-5`}>
        { blok.blocks
