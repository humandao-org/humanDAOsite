        ...
        <header className="py-32 px-5 lg:pt-52 lg:pb-80">
          <div className="mx-auto flex w-full max-w-[1100px] flex-col items-center justify-between gap-16 lg:flex-row lg:gap-5">
            ...
            <div className="w-full max-w-[552px]">
              <img src="https://res.cloudinary.com/daljbo1q0/image/upload/v1660621598/hdao-nft/NFT_uomtba.png" alt="Banner" className="h-auto w-full origin-left object-contain lg:scale-90 lg:transform" />
            </div>
          </div>
        </header>
        <section className="mb-40 px-5 md:mb-80">
          <div className="mx-auto flex w-full max-w-[1100px] flex-col items-center justify-between gap-8 lg:flex-row">
            ...
            <div className="w-full max-w-[700px]">
              <h2 className="mb-8 pb-1 text-3.5xl font-extrabold text-primary md:mb-16 md:text-5xl">What do I need for the reservation?</h2>
              ...
              <ul className="space-y-8">
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  ...
                  <span>You will need 3,333 USDC, USDT, or DAI.</span>
                </li>
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  <span>
                    <svg className="mt-1 h-7 w-7 sm:mt-0" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>You can reserve on Polygon chain or Ethereum mainnet.</span>
                </li>
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  <span>
                    <svg className="mt-1 h-7 w-7 sm:mt-0" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>Have some MATIC or ETH to pay for gas.</span>
                </li>
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  <span>
                    <svg className="mt-1 h-7 w-7 sm:mt-0" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>PANFT will NOT mint/launch until 400 reservations are received.</span>
                </li>
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  <span>
                    <svg className="mt-1 h-7 w-7 sm:mt-0" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>Any time prior you can withdraw your funds/reservation and give up your spot.</span>
                </li>
                <li className="grid grid-cols-[max-content_1fr] gap-3 text-lg font-semibold text-dark md:gap-6">
                  <span>
                    <svg className="mt-1 h-7 w-7 sm:mt-0" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>PANFT mints on Polygon and will be sent to your reservation address ON POLYGON even if your reservation was made on Ethereum. Read FAQ for details.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mx-auto w-full max-w-[870px] space-y-12 md:space-y-20">
            ...
            <div className="faq-box group">
              ...
              <div className="pointer-events-none invisible max-h-0 text-sm font-medium leading-[30px] text-black opacity-0 transition-all duration-300 group-only:opacity-100 group-open:pointer-events-auto group-open:visible group-open:mt-4 group-open:max-h-[1080px] group-open:opacity-100 md:text-xl md:group-open:mt-9">
                ...
                <p className="pt-4">
                  <strong>
                    We will be utilizing a reservation smart contract that will allow you to reserve a PANFT by committing the full mint price, $3,333. The funds are in a escrow style smart contract and you can withdraw your funds and give up your
                    spot in line anytime prior to mint.
                  </strong>
                </p>
                <p className="pt-4">
