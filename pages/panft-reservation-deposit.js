          ...
          <div className="mx-auto flex w-full max-w-[1100px] items-center justify-between gap-5">
            ...
            <div className="nav-list">
              <ul className="flex flex-col gap-4 md:flex-row md:items-center md:gap-12">
                ...
                <li>
                  {!account && (
                    <div className="cursor-pointer text-white bg-gray-800 hover:bg-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 m-1 inline-block" onClick={connect}>
                      Connect
                    </div>
                  )}
                </li>
