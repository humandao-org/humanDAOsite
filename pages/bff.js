...
export default function BFFPage({ story }) {
  ...
  return (
    <div className=" bg-gradient-to-b from-black via-bffv to-bffb">
      <Head>
      ...
      <div className="relative z-10 mx-auto w-full">
        ...
        <header className="py-16 px-5 lg:pt-52 lg:pb-40">
          <div className="mx-auto flex w-full max-w-[1100px] flex-col items-center justify-between gap-16 lg:flex-row lg:gap-5">
            <div className="w-full max-w-[548px] text-center lg:text-left">
              <h1 className="mb-7 font-primary text-4xl font-extrabold tracking-[0.46px] text-[#fdb414] sm:text-5xl md:text-6xl lg:mb-3">Get Back Your Time With PANFT</h1>
              ...
              <Link href="/deposit?community=moonbirds">
                <a className="mx-auto block w-fit rounded-full bg-bffv px-8 py-4 text-base font-bold text-white shadow-sm transition-all duration-200 hover:shadow-none md:px-10 md:text-xl lg:mx-0">Reserve your NFT</a>
              </Link>
            </div>
        ...
        <section className="mb-40 px-5 md:mb-80 ">
          <div className="mx-auto flex w-full max-w-[1100px] flex-col items-center justify-between gap-8 md:flex-row">
            ...
            <div className="w-full max-w-[700px]">
              <h2 className="mb-8 pb-1 text-3.5xl font-bold font-primary text-white md:mb-16 md:text-5xl">What do I need for the reservation?</h2>
        ...
        <section id="faqs" className="px-5 pb-40">
          <h2 className="mb-14 text-center text-3.5xl font-bold font-primary leading-none text-black md:mb-28 md:text-5xl">FAQ</h2>
          ...
          <div className="mx-auto w-full max-w-[870px] space-y-12 md:space-y-20">
            <div className="faq-box group">
              ...
              >
                <span className="text-black">What chain will the PANFT use?</span>
              ...
              <div className="pointer-events-none invisible max-h-0 text-sm font-medium leading-[30px] text-black opacity-0 transition-all duration-300 group-only:opacity-100 group-open:pointer-events-auto group-open:visible group-open:mt-4 group-open:max-h-[1080px] group-open:opacity-100 md:text-xl md:group-open:mt-9">
                ...
                <p className="pt-4">
                  If using Metamask,{' '}
                  <a className="underline hover:text-white" href="https://bit.ly/hdao-tokens" target="_blank" rel="noreferrer">
                    here
                  </a>{' '}
            ...
            <div className="faq-box group">
              ...
              >
                <span className="text-black">How many NFTs are available?</span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            ...
            <div className="faq-box group">
              ...
              >
                <span className="text-black">What will it cost to mint?</span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            ...
            <div className="faq-box group">
              ...
              >
                <span className="text-black">What are the features and benefits of the NFT?</span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            ...
            <div className="faq-box group">
              ...
              >
                <span className="text-black">Why do we have to hodl or stake HDAO?</span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              <div className="pointer-events-none invisible max-h-0 text-sm font-medium leading-[30px] text-black opacity-0 transition-all duration-300 group-only:opacity-100 group-open:pointer-events-auto group-open:visible group-open:mt-4 group-open:max-h-[1080px] group-open:opacity-100 md:text-xl md:group-open:mt-9">
                ...
                <p className="pt-4">
                  <a className="underline hover:text-white" href="https://app.humandao.org/buyhdao" target="_blank" rel="noreferrer">
                    Buy HDAO here
                  </a>
                </p>
                <p className="pt-4">
                  <a className="underline hover:text-white" href="https://app.humandao.org/dashboard" target="_blank" rel="noreferrer">
            ...
            <div className="faq-box group">
              ...
              >
                <span className="text-black">What is the design/art for the NFT?</span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              <div className="pointer-events-none invisible max-h-0 text-sm font-medium leading-[30px] text-black opacity-0 transition-all duration-300 group-only:opacity-100 group-open:pointer-events-auto group-open:visible group-open:mt-4 group-open:max-h-[1080px] group-open:opacity-100 md:text-xl md:group-open:mt-9">
                ...
                <p className="pt-4">
                  ...
                  <a className="underline hover:text-white" href="https://artcontest.humandao.org" target="_blank" rel="noreferrer">
                  ...
                  <a className="underline hover:text-white" href="https://twitter.com/humanDAO" target="_blank" rel="noreferrer">
                    Twitter
                  </a>
                  , subscribe to our{' '}
                  <a className="underline hover:text-white" href="https://medium.com/@TheHumanDAO" target="_blank" rel="noreferrer">
                    blog
                  </a>
                  , or join our{' '}
                  <a className="underline hover:text-white" href="https:/discord.com/invite/humandao" target="_blank" rel="noreferrer">
                    Discord
                  </a>{' '}
                  for the kickoff.
                </p>
        ...
        <section className="contact pb-12">
          <div className="mx-auto flex w-full max-w-[900px] flex-wrap px-5">
            <div className="min-w-[250px] flex-1 overflow-hidden rounded-lg px-5 pt-8 pb-8 text-center border-2 border-black">
              <h3 className="mb-2 text-3.5xl font-bold leading-none text-black">Stay updated on PANFT</h3>
              <form onSubmit={handleEmailSubmit}>
                <input required placeholder="Email address" type="email" className=" text-center bg-slate-50 rounded-md w-2/3 mt-4 px-4 py-4" onChange={(event) => setEmail(event.target.value)}></input>
                <button className="mx-auto mt-8 block w-fit rounded-full bg-bffv px-8 py-4 text-base font-bold text-white shadow-sm transition-all duration-200 hover:shadow-none sm:px-10 md:text-xl">Notify me</button>
