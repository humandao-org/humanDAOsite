      ...
      <div className="relative z-10 mx-auto w-full overflow-hidden">
        ...
        <section className="py-20 px-5 lg:pt-24 lg:pb-56">
          <div className="mx-auto w-full max-w-[1110px]">
            <h1 className="mb-7 text-center font-primary text-4xl font-extrabold tracking-[0.46px] text-primary sm:text-5xl md:text-6xl">Become an Ambassador</h1>
            ...
            <div className="rounded-[10px] bg-white px-8 pt-16 pb-[75px] shadow-box">
              <ul className="mx-auto mb-16 flex w-full max-w-sm flex-wrap items-center justify-center gap-x-6 gap-y-3 pb-1 sm:justify-between">
                ...
                <li className="text-base font-semibold -tracking-default text-dark/20 open:text-dark md:text-xl md:leading-7">2. Ambassador Link</li>
              </ul>

              <form className="mx-auto w-full max-w-[597px] space-y-7 sm:space-y-9" onSubmit={handleSubmit}>
                ...
                <div className="relative">
                  ...
                  {!error.success ? <span className="inline-flex text-sm text-red-700">{error.emailMmessage}</span> : null}
                </div>
                ...
                <div className="pt-2.5">
                  <button type="submit" className="mx-auto block w-fit rounded-full bg-accent-purple px-8 py-4 text-base font-bold text-white shadow-sm transition-all duration-200 hover:shadow-none md:px-10 md:text-xl">
