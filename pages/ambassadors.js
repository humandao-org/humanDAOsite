    ...
    <div className="bg-[#F8F3F3]">
      <div className="relative z-10 mx-auto w-full overflow-hidden">
          ...
          <div className="mx-auto flex w-full max-w-[1100px] items-center justify-between gap-5">
            ...
            <div className="nav-list">
              <ul className="flex flex-col gap-4 md:flex-row md:items-center md:gap-12">
                <li>
                  <a href="#" className="text-[15px] font-medium text-black hover:underline">PANFT site</a>
                </li>
                <li>
                  <a href="#" className="text-[15px] font-medium text-black hover:underline">FAQs</a>
                </li>
                <li className="mx-auto md:mx-0">
                  <Link href="/ambassador-registration">
                    <a 
                      className="block rounded bg-secondary/[0.04] py-2 px-3 text-[15px] font-medium leading-6 tracking-[0.46px] text-secondary">Become
                      an ambassador</a>
                  </Link>
                </li>
              </ul>
          ...
          <div className="mx-auto flex w-full max-w-[1100px] flex-col items-center justify-between gap-16 lg:flex-row lg:gap-5">
            <div className="w-full max-w-[548px] text-center lg:text-left">
              <h1
                ...
                Join the PANFT<br className="hidden sm:inline-block" />
                Ambassadors
              </h1>
              <p className="mb-7 text-xl font-semibold leading-[30px] -tracking-default text-dark md:text-2xl lg:mb-3">
                Support the underserved and get paid to help spread the word about
                this novel NFT project.
              </p>
              <Link href="/ambassador-registration">
                <a 
                  className="mx-auto block w-fit rounded-full bg-accent-purple px-8 py-4 text-base font-bold text-white shadow-sm transition-all duration-200 hover:shadow-none md:px-10 md:text-xl lg:mx-0">Become
                  an ambassador</a>
              </Link>
            </div>
            <div className="w-full max-w-[552px]">
              <img src="assets/images/panft-ambassador.png" alt="Panft Ambassador"
        ...
        <section className="mb-40 px-5 md:mb-80">
          <h2 className="mb-14 pb-1 text-center text-3.5xl font-extrabold leading-none text-primary md:mb-24 md:text-5xl">
            Anyone can join!
          </h2>

          <div className="mx-auto flex w-full max-w-[1100px] flex-wrap gap-8">
            <div
              className="min-w-[250px] flex-1 overflow-hidden rounded-lg bg-card bg-cover px-5 pt-8 pb-14 text-center shadow-circle">
              <div
                className="mx-auto mb-6 flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#F8F8F8] text-2xl font-extrabold leading-none shadow-circle">
                ✏️
              </div>
              <h3 className="mb-6 text-3.5xl font-bold leading-none text-black">
                1. Sign up️
              </h3>
              <p className="mx-auto w-full max-w-[230px] text-xl font-medium text-black">
                Start by filling out the form to get your Ambassador link
              </p>
            </div>
            ...
            <div
              ...
              <p className="w-full text-xl font-medium text-black">
                Utilize PANFT &#34;as&#34; something new to share with your community
              </p>
            </div>
            ...
            <div
              ...
              <p className="mx-auto w-full max-w-[267px] text-xl font-medium text-black">
                Earn fees for every person using your link to mint a PANFT
              </p>
            </div>
          </div>
            ...
            <div className="faq-box group" open>
              <button
                ...
                <span>What is an Ambassador?
                  <img src="assets/images/saluting-face.png" className="inline-block h-7 w-7 object-contain align-middle"
                    alt="" /></span>
                <svg className="block h-6 w-6 transform transition-all duration-200 group-open:rotate-180 md:h-8 md:w-8"
                  ...
                  <path d="M23.75 9.677L15 17.2036L6.25 9.677" stroke="#111827" strokeWidth="3" strokeLinecap="round"
